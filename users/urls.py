...
from .views import (
    ...
    DirectorStatusView, 
    ParentEmailNotificationSettingsView,
...
urlpatterns = [
    ...
    path('password_reset/', CustomResetPasswordRequestTokenViewSet.as_view({'post': 'create'}), name='password-reset-request'),
    path('password_reset/', include('django_rest_passwordreset.urls', namespace='password_reset')),
    path('me/', CurrentUserView.as_view(), name='current-user'),
    path('me/email-notifications/', ParentEmailNotificationSettingsView.as_view(), name='parent-email-notification-settings'),
